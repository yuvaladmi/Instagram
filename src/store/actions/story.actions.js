...
import { ADD_STORY, REMOVE_STORY, SET_STORIES, SET_IS_LOADING, UNDO_STORIES, UPDATE_STORY } from "../reducers/story.reducer.js";
...
export function loadStories() {
    ...
    return storyService.query(filterBy)
        .then(stories => {
...
export function removeStoryOptimistic(storyId) {
    ...
    return storyService.remove(storyId)
        .catch(err => {
